...
def main():
    ...
    # LTC-S
    stdArrival(masterCallsign, controllerSock, "EGKK", 120, [  # KK arrivals
    ...
    stdArrival(masterCallsign, controllerSock, "EGLL", 120, [  # LL arrivals
...
#After ICAO, dealy in seconds
    ...
    stdArrival(masterCallsign, controllerSock, "EGNX", 80, [
