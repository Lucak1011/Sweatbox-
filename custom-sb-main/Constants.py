...
ACTIVE_CONTROLLERS = ["LTC_SW_CTR", "LTC_CTR", "EGSS_APP", "EGCC_S_APP", "EGGW_APP", "LTC_N_CTR", "LTC_SE_CTR", "EGKK_F_APP", "EGLL_S_APP", "EGLL_F_APP", "EGLL_N_APP", "EGKK_APP", "EGNX_APP" ]  # "ESSEX_APP", 
